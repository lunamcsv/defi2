...
contract ExampleFlashSwap is IPancakeCallee {
    ...
    function pancakeCall(address sender, uint amount0, uint amount1, bytes calldata data) external override {
        ...
        if (amountToken > 0) {
            ...
            uint amountReceived = exchangeV1.tokenToEthSwapInput(amountToken, minETH, ~uint(0));
            ...
            uint amountReceived = exchangeV1.ethToTokenSwapInput{value: amountETH}(minTokens, ~uint(0));
